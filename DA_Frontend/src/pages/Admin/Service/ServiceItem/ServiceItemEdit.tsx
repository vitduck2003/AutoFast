...
import { ISevice, ISeviceItem } from '../../../../interface/service';
...
const ServiceItemEdit = (props: Props) => {
  ...
  useEffect(() => {
    const currentService = props.serviceItem.find((se: ISeviceItem) => se.id === Number(id));
  ...
  return (
    <div>
      ...
      >
        ...
        <Form.Item label="Price" name="price" rules={[{ required: false, message: '' }]}>
          <Input />
        </Form.Item>

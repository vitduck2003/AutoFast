...
>
  <Button danger>Delete</Button>
        ...
        <Link to={`/admin/service/${record.id}/edit`}><Button type="primary">Edit</Button></Link>
...
const data: DataType[] = props.service ? props.service.map((item: IService) => {
  return {
      key: item.id,
      ...item
  }
  ...
  return (
    <div>
      <Link style={{marginLeft: '20px'}} to={`/admin/service/add`}><Button type="primary">Thêm mới Service</Button></Link>

              ...
              <div className="container">
                <div className="row align-items-center justify-content-center justify-content-lg-start">
                  <div className="col-10 col-lg-7 text-center text-lg-start">
                    <h6 className="text-white text-uppercase mb-3 animated slideInDown">// Dịch vụ //</h6>
                    <h1 className="display-3 text-white mb-4 pb-3 animated slideInDown">Bảo dưỡng và sửa chữa xe</h1>
                    
                    <a href="service" className="btn btn-primary py-3 px-5 animated slideInDown">Xem thêm<i className="fa fa-arrow-right ms-3"></i></a>
                  </div>
            ...
            <div className="carousel-caption d-flex align-items-center">
              <div className="container">
                <div className="row align-items-center justify-content-center justify-content-lg-start">
                  <div className="col-10 col-lg-7 text-center text-lg-start">
                    <h6 className="text-white text-uppercase mb-3 animated slideInDown">// Dịch vụ //</h6>
                    <h1 className="display-3 text-white mb-4 pb-3 animated slideInDown">Thay dầu, vệ sinh và thay thế phụ tùng</h1>
                    <a href="service" className="btn btn-primary py-3 px-5 animated slideInDown">Xem thêm<i className="fa fa-arrow-right ms-3"></i></a>
                  </div>
                  <div className="col-lg-5 d-none d-lg-flex animated zoomIn">
      ...
      <div className="container">
        <div className="row g-5">
          ...
          <div className="col-lg-6">
            ...
            <a href="about" className="btn btn-primary py-3 px-5">Xem thêm<i className="fa fa-arrow-right ms-3"></i></a>
          </div>
        </div>
      </div>
    </div>
              ...
              <div className="tab-pane fade show active" id="tab-pane-1">
                <div className="row g-4">
                  ...
                  <div className="col-md-6">
                    ...
                    <a href="booking" className="btn btn-primary py-3 px-5 mt-3">Đặt lịch<i className="fa fa-arrow-right ms-3"></i></a>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.7s">
            <div className="team-item">
              ...
              <div className="bg-light text-center p-4">
                ...
                <small>Hơn 20 năm kinh nghiệm đóng vai trai alime tại Osaka Nhật bản</small>
              </div>
            </div>
          </div>
        </div>

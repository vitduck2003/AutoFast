...
<div class="row">
    <div class="col-6"> <div class="staff"> <div class="staff-body"> <h4 class="staff-title">Đây là sửa nhân viên</h4>
    <form action="{{route('staff-update',['id'=>$staff->id])}}" method="POST" style="display: inline;" enctype="multipart/form-data"> 
        @csrf 
        @method('PUT')
    <div class="mb-3">
    ...
    <div class="mb-3"> <label class="form-label">Số điện thoại</label> <input type="text" class="form-control"
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="description" value="{{ $staff->description}}"> </div>
